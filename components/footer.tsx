        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
          ...
          <div className="grid grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 text-sm mb-2">E-mail</h4>
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-gray-900 text-sm mb-2">Phone</h4>
                <p className="text-gray-600 text-sm">(406) 555-0120 Ext</p>
              </div>
              <div>
                <h4 className="font-semibold text-gray-900 text-sm mb-2">Open Time</h4>
          ...
          {/* Newsletter */}
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-gray-900">Bright News & Special Offers</h3>
            <div className="flex gap-2">
              <Input placeholder="Enter your E-mail" className="flex-1 border-gray-200" />
