          ...
          <div className="relative w-full flex justify-start">
            <div className="relative w-full max-w-md md:max-w-lg rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="absolute bottom-3 md:bottom-4 left-12 md:left-16 z-20">
                <div className="bg-white rounded-full px-3 py-1.5 shadow flex items-center gap-2 border border-gray-100 text-[10px] md:text-xs">
                  <span className="text-gray-900 font-semibold">Trusted By</span>
            ...
            <div className="absolute bottom-3 md:bottom-4 -left-8 md:-left-16 z-20 flex items-center">
              <div className="flex -space-x-2">
                <Image src="/professional-woman-smiling-headshot.png" alt="Customer" width={28} height={28} className="rounded-full border-2 border-white" />
                <Image src="/professional-man-smiling-headshot.png" alt="Customer" width={28} height={28} className="rounded-full border-2 border-white" />
                <Image src="/professional-woman-smiling-headshot-diverse.png" alt="Customer" width={28} height={28} className="rounded-full border-2 border-white" />
